...
![](attachments/Pasted%20image%2020260113175057.png)
![](attachments/Pasted%20image%2020260113175125.png)
## Lesson 4-Benefits of agent AI
### 将模型封装到工作流以提升表现

### 并行处理
![](attachments/Pasted%20image%2020260113180724.png)
多个大模型并行处理问题
### 模块化设计可更换工具或模型
![](attachments/Pasted%20image%2020260113181022.png)
## Lesson 5-AI Applications
![](attachments/Pasted%20image%2020260113181359.png)
![](attachments/Pasted%20image%2020260113182249.png)
![](attachments/Pasted%20image%2020260113182332.png)
![](attachments/Pasted%20image%2020260113182105.png)
...
![](attachments/Pasted%20image%2020260115125147.png)
#### 思考作为一个人如何去执行写文章这个task
![](attachments/Pasted%20image%2020260115125426.png)
PS：拆分步骤后注意考虑LLM对这些步骤的可执行性
Q：按照这个步骤的输出可能依旧太浅显同时文章上下文不关联
A：如果作为一个人发现文章出现这些问题会如何修改
#### 将其中steps再拆分
![](attachments/Pasted%20image%2020260115125813.png)
#### 总结
![](attachments/Pasted%20image%2020260115130008.png)
### What building blocks do you have?
![](attachments/Pasted%20image%2020260115130721.png)
### Generation
...
![](attachments/Pasted%20image%2020260115160728.png)
### Add an evaluation to track your error
构建key-word list，通过编码统计
![](attachments/Pasted%20image%2020260115161146.png)
这是一种客观标准，而对于更主观的，则可考虑使用LLM作为evaluation standard
### Using LLM as a judge
规定评分标准
![](attachments/Pasted%20image%2020260115161513.png)
...
![](attachments/Pasted%20image%2020260115163512.png)
### Tool use
![](attachments/Pasted%20image%2020260115163713.png)
除了大量工具的提供还可以让LLM本身决定是否使用以及如何使用tools
### Planing
![](attachments/Pasted%20image%2020260115163919.png)
...
![](attachments/Pasted%20image%2020260115191357.png)
### Reflection to improve code
![](attachments/Pasted%20image%2020260115191703.png)
reasoning model-推理模型
### Reflection with external feedback
![](attachments/Pasted%20image%2020260115191852.png)
...
![](attachments/Pasted%20image%2020260115192946.png)
一次输入直接生成答案
### Zero, one and few-shot prompting
![](attachments/Pasted%20image%2020260115193106.png)
### Tasks where reflection works better 
![](attachments/Pasted%20image%2020260115200143.png)
### Tips for writing reflection prompts
![](attachments/Pasted%20image%2020260115200424.png)
![](attachments/Pasted%20image%2020260115200552.png)
...
![Pasted image 20260117181422](attachments/Pasted%20image%2020260117181422.png)
### What about subject tasks?
#### Using an LLM as a judge
![Pasted image 20260121224903](attachments/Pasted%20image%2020260121224903.png)
![[attachments/Pasted image 20260121225149.png]]
...
![[attachments/Pasted image 20260121225629.png]]
